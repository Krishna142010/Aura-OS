...
const styles = {
  ...
  icon: { color: "#6366F1", fontSize: "20px" },
  title: { fontSize: "13px", fontWeight: "600", marginBottom: "4px" },
  message: { fontSize: "12px", color: "rgba(255,255,255,0.6)", lineHeight: "1.4" },
  progressBar: { position: "absolute", bottom: 0, left: 0, height: "3px", background: "#6366F1", animation: "shrink 4s linear forwards" }
};

// Add this to your main CSS file for the toast progress bar
